...
#ifndef TESTENV
#define AMW_CORRIDOR_DEBUG
#define AMW_CORRIDOR_LOGGING
#endif
...
#define AMW_CORRIDOR_RESERVATION_TIMEOUT 4
#define AMW_CORRIDOR_RESERVATION_TIMEOUT_MAX_DELTA 1
#define AMW_CORRIDOR_RESERVATION_FAILURE_RETRY_DELAY 15
#define AMW_CORRIDOR_RESERVATION_FAILURE_RETRY_DELAY_MAX_DELTA 5
#define AMW_CORRIDOR_RESERVATION_ROUND_DELAY 0
#define AMW_CORRIDOR_RESERVATION_ROUND_DELAY_MAX_DELTA 3
